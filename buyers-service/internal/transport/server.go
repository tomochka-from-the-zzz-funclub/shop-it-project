...
type Server struct {
	...
	httpBuyersService *httpBuyersService
...
func (srv *Server) WithLog() *Server {
	if srv.httpBuyersService != nil {
		srv.httpBuyersService = srv.BuyersService().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpBuyersService != nil {
		srv.httpBuyersService = srv.BuyersService().WithMetrics()
	}
	return srv
}

func (srv *Server) BuyersService() *httpBuyersService {
	return srv.httpBuyersService
}
